...
### Обновление
Для обновления проекта достаточно запустить bash скрипт. Он обновляет библиотеки, пересобирает данные, производит миграци и обновляет сервисы.
```sh
./updater.sh
```
Внимание! Внесите изменения в файл в соответствии с конфигурацией вашего сервера. Может отличаться путь до файла испольнителя bash, реаилзованные сервисы и прочее.
